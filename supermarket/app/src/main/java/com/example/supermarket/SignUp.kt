...
//        editor.commit()
        ...
        SignUpBtn.setOnClickListener {
            ...
            if (isEmailFormal(userEmail)) {
                ...
                Toast.makeText(this, "please enter a working email address", Toast.LENGTH_SHORT).show()
            }
//val password=password.text.toString().trim()
            ...
            if (Address.isNotEmpty() and Age.isNotEmpty() and checkPasswordStrength(passwprd) and isEmailFormal(userEmail) and ConPassword.isNotEmpty() and Passwprd.isNotEmpty() and Phone.isNotEmpty() and Email.isNotEmpty() and Username.isNotEmpty() and conpassword.text.toString()
