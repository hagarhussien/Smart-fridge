...
//    private fun startSmartUserConstant(){
...
//        if(matcher.find()){
//
//            otpEt1!!.setText(matcher.group(0))
//            otpEt2!!.setText(matcher.group(1))
//            otpEt3!!.setText(matcher.group(2))
//            otpEt4!!.setText(matcher.group(3))
//        }
//    }
//
//    private fun registerBroadcastReceiver(){
//        smsBroadCastreciver= SmsBroadCastreciver()
//        smsBroadCastreciver!!.smsBroadCastRecuverListener=object : SmsBroadCastreciver.SmsBroadCastRecuverListener{
